  ...
  return (
    <div className="container">
      ...
      <div className="mt-3 d-grid gap-3 text">
        ...
        <p className="intro mx-5" style={{fontSize: "24px"}}><strong style={{color: "var(--accent3)", fontSize: "2rem", fontFamily: "Helvetica, sans-serif", textAlign: "center", margin: "0"}}>Engineer & Artist:</strong> <br></br>
